...
export interface ApiCouponCoupon extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    minPurchase: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDiscountDiscount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cards: Schema.Attribute.Component<'discount.discount-cards', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface ApiEzimartUserEzimartUser extends Struct.CollectionTypeSchema {
  collectionName: 'ezimart_users';
  info: {
    displayName: 'Ezimart User';
    pluralName: 'ezimart-users';
    singularName: 'ezimart-user';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGlobalSettingGlobalSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    enableFlashSale: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    flashSaleEndTime: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    billingAddress: Schema.Attribute.Component<'order.shipping-address', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    shipping: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    availableItems: Schema.Attribute.String;
    ...
    flashSaleEndTime: Schema.Attribute.DateTime;
    heading: Schema.Attribute.Component<'product.bulk-cards', false>;
    images: Schema.Attribute.Media<'images', true>;
    isFeatured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    isFlashSale: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['purchase', 'topup', 'refund', 'cashback']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiUserCouponUserCoupon extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ezimart-user.ezimart-user': ApiEzimartUserEzimartUser;
